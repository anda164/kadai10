...
<?php
    ...
    if (!isset($_SESSION["login"])) {
        ...
        //exit();
        $header = "<p>編集するにはログインしてください。<a href='./login.php'>ログイン</a>";
        
    }else{
        
        $header = "<p>".$_SESSION["login"]."さんこんにちは。<br><a href='./logout.php'>ログアウト</a></p>";
        $buttons = "<button type='submit' name='_method' value='post' id='submit_btn' onclick='return checkMyForm();' formaction='item_write.php'>Submit</button>";
        $buttons .= "<button type='submit' name='_method' value='delete' id='delete_btn' onclick='return checkMyForm();' formaction='item_write.php'>Delete</button>";
...
<body>
    <form action="?" method="post" enctype="multipart/form-data">
        ...
        <br>
        <!--
        　* 従来のボタンをPHP埋め込みに移動（$buttons変数受け取り）
